export default {
  ...
  exampleTour: {
    ...
    step2Desc: 'Click this button to create new data records, supporting multiple data types.',
    step3Title: 'System Settings',
    step3Desc: 'Click this button to access system settings and configure system parameters.',
    step4Title: 'Export Data',
    step4Desc: 'Click this button to export current data to Excel, CSV, or other formats.',
    ...
    customStep4Desc: 'The tour panel is displayed on top of the target with a custom indicator.',
  },
  ...
  exampleQRCode: {
    ...
    logoHint: "Use errorLevel='H' to ensure QR codes with logos can be scanned correctly",
    statusActive: 'Active',
  ...
  examples: {
    scaffold: {
      ...
      importExport: {
        ...
        importHint: 'Header must be code,name,category,price,stock; rows are upserted by code.',
        colCode: 'Code',
        colName: 'Name',
      ...
      complexForm: {
        ...
        step1Description: 'Define project ownership and use case',
        step2Title: 'Policy Configuration',
        step2Description: 'Set the monitoring rules to apply',
        step3Title: 'Publish Settings',
        step3Description: 'Confirm timing and notification recipients',
      ...
      virtualTable: {
        ...
        renderedRowsTip: 'Only visible rows are rendered for smoother scrolling',
        statusActive: 'Active',
        statusInactive: 'Inactive',
        statusPending: 'Pending',
        colId: 'ID',
