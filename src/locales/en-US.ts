export default {
  ...
  menu: {
    ...
    examplesQuickStart: "Quick Start",
    examplesFormInput: "Forms & Input",
    examplesContent: "Content Editors",
    examplesInteraction: "Basic Interaction",
    examplesBusinessScaffold: "Business Scaffolds",
    examplesSecurityEngineering: "Security & Engineering",
    examplesIntegration: "Integration & Navigation",
    examplesExceptionPages: "Exception Pages",
    table: "Table Example",
    icon: "Icon Example",
    form: "Form Example",
    ...
    importExport: "Import/Export Flow",
  ...
  layout: {
    ...
    notificationsEmptyHint:
      "After clearing, new notifications will appear here",
    ...
    aiInputPlaceholder:
      "Enter your question or command (Shift+Enter for new line)",
    aiEnterHint: "Press Enter to send, Shift+Enter for new line",
    aiEmptyTitle: "Start AI Collaboration",
    aiEmptyDescription:
      "Ask AI to explain pages, summarize data, and suggest next actions",
  ...
  settings: {
    ...
    rememberTabStateHint:
      "Automatically restore previously opened tabs after refresh",
  ...
  login: {
    ...
    workspaceDescription:
      "Enter dashboards, organization permissions, menu management, and system settings from one place.",
    gridTitle: "Unified access and operations console",
    gridSubtitle: "Start with a traceable, permission-aware admin loop",
    gridLede: "Bring menus, roles, users, settings, and logs into one entry point. Teams can understand permission boundaries quickly and run daily operations with a consistent experience.",
  ...
  dashboard: {
    ...
    activities: {
      ...
      riskPolicyReleased:
        "Risk control strategy version has been released to production",
    },
    activityTags: {
      system: "System",
      user: "User",
  ...
  user: {
    ...
    importFormatError:
      'CSV format is incorrect, must include "Username", "Name", "Email" columns',
    age: "Age",
    tags: "Tags",
    address: "Address",
  ...
  permission: {
    ...
    confirmDelete:
      "Are you sure you want to delete this menu and its children?",
    ...
    codePattern:
      "Permission code only supports letters, numbers, underscores and hyphens",
  ...
  dict: {
    ...
    confirmDeleteType:
      'Are you sure you want to delete dictionary type "{name}"?',
    confirmDeleteData:
      'Are you sure you want to delete dictionary data "{label}"?',
  ...
  exampleIcon: {
    ...
    capabilities:
      "Supports: local SVG, antdv-next icons, Iconify (offline sets + online search)",
    ...
    guidesSubtitle:
      "Two common integration paths: SVG Symbol and Iconify (online + offline)",
    svgGuideTitle: "How to add and use SVG",
    iconifyGuideTitle: "How to use Iconify",
    guideStepSvg1:
      'Inject <symbol id="..."> definitions at app root (or layout root).',
    guideStepSvg2:
      "Use Icon component with svg:icon-id, e.g. svg:icon-demo-orbit.",
    guideStepSvg3:
  ...
  exampleWatermark: {
    ...
    description:
      "Global watermark feature - configure and preview watermark effects in real time",
  ...
  exampleSplitter: {
    ...
    description:
      "Splitter component creates resizable split panel layouts with horizontal/vertical splitting, nested layouts, and panel configuration.",
    basicTab: "Basic Split",
    nestedTab: "Nested Layout",
    configTab: "Panel Config",
    businessTab: "Business Example",
    horizontalSplit: "Horizontal Split (Left-Right)",
    verticalSplit: "Vertical Split (Top-Bottom)",
    leftPanel: "Left Panel",
    rightPanel: "Right Panel",
    topPanel: "Top Panel",
    bottomPanel: "Bottom Panel",
    threeColumnLayout: "Three-Column Nested Layout",
    sidebarPanel: "Sidebar",
    mainContent: "Main Content",
    footerPanel: "Footer Area",
    asidePanel: "Right Sidebar",
    minSize: "Min Size",
    maxSize: "Max Size",
  ...
  exampleSegmented: {
    ...
    description:
      "Segmented component switches between multiple options, commonly used for view switching and filtering.",
    basicTab: "Basic",
    iconTab: "Icon Options",
    blockTab: "Block Style",
    disabledTab: "Disabled",
    businessTab: "Business",
    basicUsage: "Basic Usage",
    currentValue: "Current Value",
    sizes: "Different Sizes",
    iconOptions: "Icon Only Options",
    mixOptions: "Text + Icon Mix",
    blockStyle: "Block Style (100% width)",
    allDisabled: "All Disabled",
    partialDisabled: "Partial Disabled",
    viewSwitch: "View Switch",
    filterSwitch: "Filter Condition",
    filterResult: "Filter Result",
    listItemTitle: "Data Item",
    listItemDesc: "This is the description of the data item",
    cardItemTitle: "Card",
  },
  ...
  exampleColorPicker: {
    ...
    description:
      "ColorPicker component for color selection with multiple formats, presets, and alpha support.",
    basicTab: "Basic",
    presetTab: "Presets",
    formatTab: "Formats",
    alphaTab: "Alpha",
    ...
    disabledState: "Disabled State",
    disabledHint: "Cannot select color when disabled",
    themeColor: "Theme Color Selection",
    tagColors: "Tag Color Config",
    addTag: "Add Tag",
    tagName: "Tag Name",
    tagColor: "Tag Color",
  ...
  about: {
    ...
    feature1Desc:
      "Better logic reuse, code organization, and reactive performance",
    ...
    feature3Desc:
      "Page, button, field, and API level access control out of the box",
    ...
    feature7Desc:
      "Config-driven tables and forms covering common business scenarios",
    feature8: "Mock Data Development Mode",
    feature8Desc:
      "Built-in mock system for parallel frontend and backend development",
  },
  ...
  dept: {
    ...
    hasChildrenWarning:
      "This department has child departments, please delete them first",
    deleteSuccess: "Deleted successfully",
    deleteFailed: "Delete failed",
    updateSuccess: "Updated successfully",
    createSuccess: "Created successfully",
  ...
  examples: {
    scaffold: {
      stateCache: {
        ...
        panelAInputPlaceholder:
          "Input content, switch to B and back - still retained",
        localCountLabel: "Local count: ",
        panelBDesc: "Panel B (also cached by keep-alive)",
        panelBTextPlaceholder:
          "Input content, switch tabs and return - still retained",
      ...
      importExport: {
        ...
        exportErrorReceipt: "Export Error Receipt",
        totalRows: "Total Rows",
        successRows: "Successful Rows",
        updatedRows: "Updated Rows",
        failedRows: "Failed Rows",
        importHint:
          "Header must be code,name,category,price,stock; rows are upserted by code.",
        colCode: "Code",
        colName: "Name",
        ...
        errorRaw: "Raw Data",
        emptyFile: "File is empty or has no valid rows",
        invalidHeader: "Invalid header, please use the template",
        errorRequired: "Required fields missing (code/name/category)",
      ...
      testing: {
        ...
        step1Description:
          "Cover core functions, store computation logic, and edge cases.",
        step2Title: "Then add e2e tests",
        step2Description:
          "Cover critical user paths like login, search, and list operations.",
      ...
      complexForm: {
        ...
        serverValidationError:
          'Server validation failed: project name cannot contain "fail"',
      ...
      advancedFilter: {
        ...
        emptyConditions: "No filter conditions",
        inputValue: "Enter value",
        selectValue: "Select value",
        secondValue: "Second value",
        savedSchemes: "Saved schemes:",
        noSchemes: "None",
        schemeNamePlaceholder: "Enter scheme name (max 30 chars)",
        schemeNameRequired: "Please enter scheme name",
        saveSuccess: "Filter scheme saved",
        score: "Score",
        statusActive: "Active",
        statusInactive: "Inactive",
      ...
      virtualTable: {
        ...
        searchPlaceholder: "Search username / email / department",
        allStatus: "All Status",
        totalRows: "Total {count}",
        filteredRows: "Filtered {count}",
        renderedRowsTip:
          "Only visible rows are rendered for smoother scrolling",
        statusActive: "Active",
        statusInactive: "Inactive",
        statusPending: "Pending",
        colId: "ID",
      ...
      rbac: {
        ...
        buttonPermissionHint:
          "Hint: Button rendering is controlled by PermissionButton",
      ...
      observability: {
        ...
        errorNetwork:
          "NetworkError: Request timeout, please check network connection",
        errorAuth: "AuthError: token expired, need to re-login",
        errorBusiness:
          "BusinessError: rule configuration conflict, cannot calculate",
      ...
      requestAuth: {
        ...
        logRefreshStart:
          "Trigger token refresh (only first 401 request executes)",
        logRefreshSuccess:
          "Token refresh successful, releasing queued requests",
        logRefreshFailed:
          "Token refresh failed: {message}, entering re-login state",
        ...
        logConcurrentStart:
          "Starting 5 concurrent requests, observe refresh queue behavior",
    ...
    codeEditor: {
      ...
      description:
        "Code editor component based on CodeMirror 6, supporting 14+ language syntax highlighting, JSON formatting, theme switching and more.",
