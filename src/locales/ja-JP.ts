export default {
  ...
  settings: {
    ...
    aiCollabHint:
      "トップナビゲーションバーに AI チャットのエントリアイコンを表示します",
  ...
  login: {
    ...
    workspaceDescription:
      "ダッシュボード、組織権限、メニュー管理、システム設定へ一つの入口からアクセスします。",
    gridTitle: "統合された権限と運用コンソール",
    gridSubtitle: "ログインから、追跡可能な管理サイクルへ",
    gridLede: "メニュー、ロール、ユーザー、設定、ログを一つの入口に集約します。チームは権限境界をすばやく把握し、一貫した体験で日常運用を進められます。",
  ...
  role: {
    ...
    codePattern:
      "役割コードは文字、数字、アンダースコア、ハイフンのみをサポートします",
  ...
  permission: {
    ...
    codePattern:
      "許可コードは文字、数字、アンダースコア、ハイフンのみをサポートします",
  ...
  exampleIcon: {
    ...
    renderSubtitle:
      "任意のサンプルをクリックして、以下の IconPicker に適用します。",
    ...
    guidesTitle: "統合ガイド",
    guidesSubtitle:
      "2 つの一般的な統合パス: SVG Symbol と Iconify (オンライン + オフライン)",
    svgGuideTitle: "SVGの追加と使用方法",
    iconifyGuideTitle: "アイコン化の使い方",
    guideStepSvg1:
      '<symbol id="..."> 定義をアプリ ルート (またはレイアウト ルート) に挿入します。',
    guideStepSvg2:
    ...
    guideStepIconify1:
      "iconify 名を直接渡します: ri:home-line / mdi:account / ion:apps-outline。",
    guideStepIconify2:
  ...
  proUpload: {
    ...
    dragHint:
      "ファイルをクリックまたはこの領域にドラッグしてアップロードします",
  ...
  validation: {
    ...
    passwordPattern:
      "パスワードは 8 文字以上で、文字と数字を含める必要があります",
  ...
  dept: {
    ...
    hasChildrenWarning:
      "この部門には子部門があります。最初に子部門を削除してください。",
    deleteSuccess: "正常に削除されました",
    deleteFailed: "削除に失敗しました",
    updateSuccess: "正常に更新されました",
    createSuccess: "正常に作成されました",
  ...
  examples: {
    scaffold: {
      ...
      importExport: {
        ...
        parseFailed:
          "CSV の解析に失敗しました。ファイル形式を確認してください。",
      },
      testing: {
        title: "テスト例",
        description:
        ...
        step1Description:
          "コア機能、ストア計算ロジック、およびエッジケースをカバーします。",
        step2Title: "次に、e2e テストを追加します",
        step2Description:
          "ログイン、検索、リスト操作などの重要なユーザー パスをカバーします。",
        step3Title: "CIとの統合",
        step3Description:
      ...
      observability: {
        ...
        errorAuth:
          "AuthError: トークンの有効期限が切れたので、再ログインする必要があります",
      ...
      requestAuth: {
        ...
        logRefreshSuccess:
          "トークンの更新が成功し、キューに入れられたリクエストが解放されました",
        logRefreshFailed:
          "トークンの更新に失敗しました: {message}、再ログイン状態に入ります",
        logQueueWait:
          "進行中の更新が検出され、リクエストがキューに入れられました",
        logNon401Error: "[{apiName}] 401 以外のエラー: {message}",
        log401Detected:
          "[{apiName}] 401 が検出されました。トークンのリフレッシュを準備しています",
        logTokenExpired:
          "アクセス トークンを手動で期限切れとしてマークしました",
        logSessionReset:
          "セッションがリセットされ、新しいリクエストの準備が整いました",
        singleRequestFailed: "単一のリクエストが失敗しました",
        logConcurrentStart:
          "5 つの同時リクエストを開始し、リフレッシュ キューの動作を観察します",
        concurrentPartialFail:
          "同時リクエストは完了しましたが、{count} は失敗しました",
    ...
    jsonInput: {
      ...
      i18nKeysHint:
        "label-map プロップを使用してキーに i18n ラベルを提供します",
    ...
    i18nInput: {
      ...
      currentLocaleHint:
        "ロケールプロパティを使用して、入力に表示する言語値を指定します",
