export default {
  ...
  exampleForm: {
    ...
    remote: {
      title: 'リモートデータ選択',
      description: 'Select のリモート検索、TreeSelect の遅延展開、リモート検索を紹介します。',
      selectTitle: 'Select リモート検索',
      selectHint: '名前または部署を入力し、デバウンスと古い応答の破棄を確認できます。',
      selectPlaceholder: 'ユーザーを検索（例：Lin、Design）',
      lazyTreeTitle: 'TreeSelect 遅延展開',
      lazyTreeHint: '地域ノードを展開すると、次階層の組織データを読み込みます。',
      lazyTreePlaceholder: '組織を展開して選択',
      searchTreeTitle: 'TreeSelect リモート検索',
      searchTreeHint: '組織を検索し、一致したノードと親階層を表示します。',
      searchTreePlaceholder: '組織を検索（例：Platform）',
      empty: '一致する結果はありません',
    },
    roles: {
      admin: '管理者',
  ...
  examples: {
    scaffold: {
      ...
      complexForm: {
        ...
        step1Title: '基本情報',
        step1Description: 'プロジェクトの担当と利用目的を入力します',
        step2Title: 'ポリシーの構成',
        step2Description: '適用する監視ルールを設定します',
        step3Title: '設定の公開',
        step3Description: '公開日時と通知先を確認します',
