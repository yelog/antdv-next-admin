...
import type { ProStatusMap, ProTableColumn } from '@/types/pro'
import { DeleteOutlined } from '@antdv-next/icons'
import { message, Modal } from 'antdv-next'
import { computed, ref } from 'vue'
import { useI18n } from 'vue-i18n'
import { clearLoginLog, clearOperationLog, getLoginLogList, getOperationLogList } from '@/api/log'
...
async function loadOperationLogs(params: any) {
  try {
...
async function loadLoginLogs(params: any) {
  try {
...
function handleClearOperationLog() {
  Modal.confirm({
